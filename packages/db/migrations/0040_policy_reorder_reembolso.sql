...
Versão: 1.1
Vigência a partir de: 18/09/2026

Este documento descreve as regras de uso do Ady, incluindo privacidade,
telemetria, tratamento de dados, compartilhamento e reembolso. Ao usar o
Ady, você concorda com estas políticas. Revisado continuamente conforme o
produto evolui.


--------------------------------------------------------------------------------
1. TELEMETRIA E LOGS ANÔNIMOS DE MELHORIA
--------------------------------------------------------------------------------
...
telemetria descritos na seção 1:
...
CONTATO
--------------------------------------------------------------------------------
Para dúvidas sobre privacidade, uso dos seus dados ou reembolso, entre em
