      ...
      try {
        ...
        creatives = ads.map((ad) => {
          ...
          return {
            ...
            imageUrl: linkData?.picture ?? videoData?.image_url ?? photoData?.url ?? c?.thumbnail_url,
            ...
            const fallbackCreatives = adCreatives
              .map((ac) => {
                ...
                return {
                  ...
                  imageUrl: ac.thumbnail_url ?? ac.object_story_spec?.link_data?.picture ?? ac.object_story_spec?.video_data?.image_url,
