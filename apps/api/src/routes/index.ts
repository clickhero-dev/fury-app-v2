...
import { searchMetaLocationsHandler, searchMetaInterestsHandler, debugSearchNeighborhoodsHandler, debugSuggestRadiusHandler } from "../controllers/campaigns.controller.js";
...
router.get("/campaigns/debug-suggest-radius", authMiddleware, checkSubscriptionActive, tenantOrSuperadminMiddleware, debugSuggestRadiusHandler);
