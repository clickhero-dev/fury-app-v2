...
export function Select({ className, children, ...props }: SelectProps) {
  return (
    <div className="relative">
      <select
        className={cn(
          'w-full appearance-none px-4 py-3 pr-10 border border-border rounded-lg bg-surface text-text-primary transition-all duration-200 focus:outline-none focus:border-[#E8631A] focus:ring-2 focus:ring-[#E8631A]/20 hover:border-[#E8631A]/40 disabled:opacity-50 disabled:bg-gray-50 disabled:cursor-not-allowed text-base font-medium',
          className
        )}
        {...props}
      >
