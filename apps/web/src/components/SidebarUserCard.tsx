...
export function SidebarUserCard({ collapsed = false }: SidebarUserCardProps) {
  ...
  return (
    ...
    >
      ...
      <div className="w-9 h-9 rounded-full bg-[rgb(228,_237,_240)] text-[#17708A] dark:bg-[#122b2e] dark:text-[#22d3ee] flex items-center justify-center text-sm font-semibold shrink-0">
        {initial}
      </div>
