...
/**
 * Formulário de cadastro manual (email/senha) com verificação por OTP.
 */
      ...
      <div className="relative z-10 w-full max-w-[400px]">
        ...
        >
          <div className="space-y-1 mb-2">
            ...
            <p className="text-sm text-slate-600 dark:text-zinc-400">Preencha seus dados para começar</p>
          </div>
